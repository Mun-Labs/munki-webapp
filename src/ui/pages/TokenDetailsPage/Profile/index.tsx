...
export const Profile: FC<TokenDetailsPageProps> = (props) => {
  const { style } = props;
        ...
        <div>
          ...
          >
            <Flex align="center" gap={12}>
              <img src="/public/icon-solana.png" width={30} height={30} />
              <p>0xh2d.......i75d</p>
            </Flex>
            <img
              style={{
              ...
              src={isCopy ? "/public/checked.svg" : "/public/icon-copy.png"}
              width={40}
              height={40}
            />
          </Flex>
