...
export const MunkiHeader = () => {
  ...
  return (
    <section className="header" style={headerStyles}>
      <Flex justify="space-between" align="center" style={{ height: 64 }} wrap={true}>
        <img
          width="60"
          height="60"
          src='/public/munki-header.png'
          onClick={showDrawer}
          alt='munki'
        />
        <Flex>
      ...
      <Drawer
        ...
        open={open}
      >
        <Collapse expandIconPosition='end' style={{ whiteSpace: 'nowrap' }} items={items} bordered={false} size="small" />
      </Drawer>
    </section>
  );
};
